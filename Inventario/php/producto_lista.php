    ...
    if($total>=1 && $pagina<=$Npaginas){
     ...
     $tabla.='</p>
        ...
        <div class="media-content">
            <div class="content">
                <p>
                    <strong>'.$contador.' - '.$rows['producto_nombre'].'</
                    strong><br>
