<?php
    ...
    function conexion(){
        $pdo = new PDO('mysql:host=localhost;dbname=inventario servicentro','root','');
        return $pdo;
    }

    # Verificacion de datos #
    function vericar_datos($filtro,$cadena){
    ...
    # Limpiar cadenas de texto usando funciones php #
    ...
    function paginador_tablas($pagina,$Npaginas,$url,$botones){
        ...
        if($pagina<=1){
            $tabla.='
            <a class="pagination-previous is-disabled" disable >Anterior</a>
